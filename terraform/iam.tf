...
# 2. Create the specific IAM role for your application pods
...
# 3. Define the specific S3 AND Secrets Manager permissions policy
...
# 4. Attach the S3 policy to the application role
...
# 5. Output the new Role ARN so we can easily copy it to Kubernetes
